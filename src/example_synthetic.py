...
# Imports
###############################################################################
from synthetic_data_tools import generateDateFromString, generateSyntheticTradesDataset
from bond_event_study_tools import calculateBondPrices, calculateBondReturns, calculateBenchmarkReturns, calculateAbnormalBondReturns, calculateFirmAbnormalReturns, calculateAbnormalStandardizedReturns, calculateAbnormalPreStandardizedReturns, calculatePreStandardizedBenchmarkReturns, calculateStandardizedBenchmarkReturns, calculateStandardizedReturns, calculateSigmasWeeks, calculateSigmas
...
"""
###############################################################################
df_input, df_events, df_cusip_permno, lst_cusips, lst_permnos, lst_dates, experiment_montecarlo_selection, df_mat_rat_group  = generateSyntheticTradesDataset(
